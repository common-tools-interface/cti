...
typedef struct
{
	char	host[HOST_NAME_MAX];	// hostname of this node in nidXXXXX\0 format - 9 chars total
...
#define SLURM_STEP_UTIL			"slurm_step_util.sh"								// name of cti slurm job step info utility
